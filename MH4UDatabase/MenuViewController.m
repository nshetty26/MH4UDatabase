...
- (void)viewDidLoad {
    ...
    if (!_menuOptions) {
        _menuOptions = [NSArray arrayWithObjects:@"Monsters", @"Weapons", @"Armor", @"Quests", @"Items", @"Combining", @"Locations", @"Decorations", @"Skill Tree",@"Wyporium", @"Veggie Elder", @"Canteen", nil];
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    } else if ([menuOption isEqualToString:@"Canteen"]) {
        CanteenTableViewController *ccTVC = [[CanteenTableViewController alloc] init];
        ccTVC.dbEngine = _dbEngine;
        [nC setViewControllers:@[ccTVC]];
    }
